...
public interface RepoAddition {
     ...
     * repository.
     * <p>
     * The <code>collectionDataType</code> represents a collection data type, e.g. a list, array,
     * set of items of the particular type.<br>
     ...
     * @see org.palladiosimulator.generator.fluent.repository.factory.FluentRepositoryFactory#newCollectionDataType(String,
     ...
     * repository.
     * <p>
     * The <code>compositeDataType</code> represents a complex data type containing other data
     * types. This construct is common in higher programming languages as record, struct, or
     * class.<br>
     ...
     * @see org.palladiosimulator.generator.fluent.repository.factory.FluentRepositoryFactory#newCompositeDataType(String,
     ...
     * @see org.palladiosimulator.generator.fluent.repository.factory.FluentRepositoryFactory#newHardwareInducedFailureType(String,
     *      org.palladiosimulator.generator.fluent.component.repositoryStructure.datatypes.ProcessingResource)
     * @see org.palladiosimulator.generator.fluent.repository.factory.FluentRepositoryFactory#newNetworkInducedFailureType(String,
     *      org.palladiosimulator.generator.fluent.component.repositoryStructure.datatypes.CommunicationLinkResource)
     * @see org.palladiosimulator.generator.fluent.repository.factory.FluentRepositoryFactory#newSoftwareInducedFailureType(String)
     ...
     * <p>
     * Interfaces are modeled as a set of signatures representing services provided or required by a
     * component. There are 3 different types of interfaces: '<em><b>OperationInterface</b></em>',
     * '<em><b>EventGroup</b></em>', '<em><b>InfrastructureInterface</b></em>'.<br>
