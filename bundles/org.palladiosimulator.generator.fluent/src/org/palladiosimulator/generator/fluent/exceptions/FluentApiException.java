...
public class FluentApiException extends RuntimeException {
     ...
     * @param <T>         the type of the reference
     * @param obj         the object reference to check for nullity
     * @param constructor the supplier of the exception constructor
     * @return {@code obj} if not {@code null}
     * @throws FluentApiException if {@code obj} is {@code null}
     */
    ...
    /**
     * Constructs a new {@code FluentApiException} with the specified detail
    ...
    /**
     * Constructs a new {@code FluentApiException} with the specified detail message
     * and cause.
     * <p>
    ...
    /**
     * Constructs a new {@code FluentApiException} with the specified cause and a
     ...
     */
    protected FluentApiException(String message, Throwable cause, boolean enableSuppression,
