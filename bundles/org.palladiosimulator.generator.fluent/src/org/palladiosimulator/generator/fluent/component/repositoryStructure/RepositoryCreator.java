...
import org.palladiosimulator.generator.fluent.component.api.RepoAddition;
...
public class RepositoryCreator extends RepositoryEntity implements Repo, RepoAddition {
    ...
    private final Map<org.palladiosimulator.generator.fluent.component.repositoryStructure.internals.ResourceSignature, ResourceSignature> internalResourceSignatures;
            ...
            for (final ResourceSignature s : resourceInterface.getResourceSignatures__ResourceInterface()) {
                if (s.getEntityName().contentEquals("process")) {
                    internalResourceSignatures.put(
                            org.palladiosimulator.generator.fluent.component.repositoryStructure.internals.ResourceSignature.PROCESS,
                            s);
                } else if (s.getEntityName().contentEquals("read")) {
                    internalResourceSignatures.put(
                            org.palladiosimulator.generator.fluent.component.repositoryStructure.internals.ResourceSignature.READ,
                            s);
                } else if (s.getEntityName().contentEquals("write")) {
                    internalResourceSignatures.put(
                            org.palladiosimulator.generator.fluent.component.repositoryStructure.internals.ResourceSignature.WRITE,
                            s);
                } else {
    ...
    public ResourceSignature getResourceSignature(
            final org.palladiosimulator.generator.fluent.component.repositoryStructure.internals.ResourceSignature resourceSignature) {
