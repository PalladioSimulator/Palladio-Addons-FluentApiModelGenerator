...
public class SystemCreator extends SystemEntity implements ISystem {
    ...
    /**
     * Searches the repositories added to the
     * org.palladiosimulator.generator.fluent.system for an
     ...
     * AssemblyContext}s added to the org.palladiosimulator.generator.fluent.system
     ...
     * ResourceRequiredRole}s added to the
     * org.palladiosimulator.generator.fluent.system for one that matches the given
     * name.
     *
     * @param name
     ...
     * OperationRequiredRole}s added to the
     * org.palladiosimulator.generator.fluent.system for one that matches the given
     * name.
     *
     * @param name
     ...
     * OperationProvidedRole}s added to the
     * org.palladiosimulator.generator.fluent.system for one that matches the given
     * name.
     *
     * @param name
     ...
     * added to the org.palladiosimulator.generator.fluent.system for one that
     ...
     * InfrastructureRequiredRole}s added to the
     * org.palladiosimulator.generator.fluent.system for one that matches the given
     * name.
     *
     * @param name
     ...
     * InfrastructureProvidedRole}s added to the
     * org.palladiosimulator.generator.fluent.system for one that matches the given
     * name.
     *
     * @param name
     ...
     * SourceRole}s added to the org.palladiosimulator.generator.fluent.system for
     ...
     * EventChannel}s added to the org.palladiosimulator.generator.fluent.system for
     * one that matches the given name.
     *
     * @param name
