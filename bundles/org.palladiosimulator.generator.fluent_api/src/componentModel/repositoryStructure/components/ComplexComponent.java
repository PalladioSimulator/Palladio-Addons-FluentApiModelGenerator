...
public abstract class ComplexComponent extends Component {
	 ...
	 * RepositoryComponent} can be fetched from the repository using the componentModel.factory,
	 ...
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfComponent(String)
	 */
	 ...
	 * @return the component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfOperationProvidedRole(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfOperationRequiredRole(String)
	 */
	 ...
	 * @return the component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfSinkRole(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfSourceRole(String)
	 */
	 ...
	 * repository using the componentModel.factory.
	 * </p>
	 * 
	 * @param assemblyContext
	 * @param eventChannel
	 ...
	 * @return the component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfEventChannel(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfSinkRole(String)
	 */
	 ...
	 * @return the component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfInfrastructureProvidedRole(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfInfrastructureRequiredRole(String)
	 */
	 ...
	 * @return the component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfResourceRequiredRole(String)
	 */
	 ...
	 * <p>
	 * Existing required roles can be fetched from the repository using the componentModel.factory,
