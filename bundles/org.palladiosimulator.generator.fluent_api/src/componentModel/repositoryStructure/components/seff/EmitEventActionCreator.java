...
public class EmitEventActionCreator extends SeffAction {
	 ...
	 * the componentModel.factory, i.e. <code>create.fetchOfEventType(name)</code>.
	 * </p>
	 * 
	 * @param eventType
	 * @return this emit event action in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfEventType(String)
	 */
	 ...
	 * the componentModel.factory, i.e. <code>create.fetchOfSourceRole(name)</code>.
	 * </p>
	 * 
	 * @param sourceRole
	 * @return this emit event action in the making
