...
public class ReleaseActionCreator extends GeneralAction {
	 ...
	 * using the componentModel.factory, i.e. <code>create.fetchOfPassiveResource(name)</code>.
	 * </p>
	 * 
	 * @param passiveResource
	 * @return this release action in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfPassiveResource(String)
	 */
