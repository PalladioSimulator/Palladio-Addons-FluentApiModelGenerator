...
public class ExternalCallActionCreator extends SeffAction {
	 ...
	 * the componentModel.factory, i.e. <code>create.fetchOfOperationSignature(name)</code>.
	 * </p>
	 * 
	 * @param signature
	 * @return this external call action in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfOperationSignature(String)
	 */
	 ...
	 * using the componentModel.factory, i.e.
	 ...
	 * componentModel.factory, e.g. <code>create.fetchOfFailureType(name)</code>.
	 * </p>
	 * 
	 * @param failure
	 * @return this external call action in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfFailureType(componentModel.repositoryStructure.datatypes.Failure)
