...
//	}
	 ...
	 * </p>
	 * <p>
	 * The <code>completeComponentType</code> can be created using the componentModel.factory, i.e.
	 ...
	 * @param completeComponentType
	 * @return the basic component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfCompleteComponentType(String)
	 * @see org.palladiosimulator.pcm.repository.BasicComponent#getParentCompleteComponentTypes()
	 * @see org.palladiosimulator.pcm.repository.CompleteComponentType
	 */
	 ...
	 * </p>
	 * <p>
	 * Create a new SEFF by using the componentModel.factory, i.e. <code>create.newSeff()</code>.
	 * </p>
	 * 
	 * @param seff
	 * @return the basic component in the making
	 * @see componentModel.factory.FluentRepositoryFactory#newSeff()
	 ...
	 * 
	 * <p>
	 * Create a new variable usage by using the componentModel.factory, i.e.
