package componentModel.repositoryStructure;
		...
		for (ResourceInterface resourceInterface : resourceTypes.getResourceInterfaces__ResourceRepository()) {
			...
			for (ResourceSignature s : resourceInterface.getResourceSignatures__ResourceInterface())
				if (s.getEntityName().contentEquals("process"))
					this.internalResourceSignatures.put(componentModel.repositoryStructure.internals.ResourceSignature.PROCESS, s);
				else if (s.getEntityName().contentEquals("read"))
					this.internalResourceSignatures.put(componentModel.repositoryStructure.internals.ResourceSignature.READ, s);
				else if (s.getEntityName().contentEquals("write"))
					this.internalResourceSignatures.put(componentModel.repositoryStructure.internals.ResourceSignature.WRITE, s);
				else
...
//	}
	...
	@Override
	public RepoAddition addToRepository(componentModel.repositoryStructure.interfaces.Interface interfce) {
...
//			repo.setId(id);
	...
	public ResourceSignature getResourceSignature(componentModel.repositoryStructure.internals.ResourceSignature resourceSignature) {
