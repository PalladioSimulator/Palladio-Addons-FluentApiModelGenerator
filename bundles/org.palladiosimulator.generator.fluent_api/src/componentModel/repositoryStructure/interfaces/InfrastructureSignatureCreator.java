...
public class InfrastructureSignatureCreator extends RepositoryEntity {
	 ...
	 * </p>
	 * <p>
	 * A {@link componentModel.repositoryStructure.internals.Primitive Primitive} data type can
	 ...
	 * </p>
	 * <p>
	 * An existing data type can be fetched from the repository using the componentModel.factory,
	 ...
	 * failures.
	 * <p>
	 * Failure types can be fetched from the repository using the componentModel.factory, i.e.
	 * <code>create.fetchOfFailureType(name)</code>.
	 * </p>
	 * 
	 * @param failureType
	 * @return this infrastructure signature in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfFailureType(String)
	 */
	 ...
	 * failures.
	 * <p>
	 * A {@link componentModel.repositoryStructure.internals.Failure Failure} type can have the
	 ...
	 * componentModel.factory, i.e. <code>create.fetchOfExceptionType(name)</code>.
	 * </p>
	 * 
	 * @param exceptionType
	 * @return this infrastructure signature in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfExceptionType(String)
	 */
