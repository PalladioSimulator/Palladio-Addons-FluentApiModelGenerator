...
public interface RecoverySeff {
	 ...
	 * {@link componentModel.apiControlFlowInterfaces.seff.StartSeff#withStartAction() start
	 ...
	 * {@link componentModel.apiControlFlowInterfaces.seff.StopSeff#createBehaviourNow()
	 * createBehaviourNow()}.
	 * 
	 ...
	 * the componentModel.factory, i.e. <code>create.fetchOfFailureType(name)</code>.
	 * 
	 * @param failureType
	 * @return this recovery behaviour in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfFailureType(String)
	 ...
	 * repository using the componentModel.factory, i.e.
	 * <code>create.fetchOfRecoveryActionBehaviour(name)</code>.
	 * </p>
	 * 
	 * @param recoveryBehaviour
	 * @return this recovery behaviour in the making
	 * @see componentModel.factory.FluentRepositoryFactory#fetchOfRecoveryActionBehaviour(String)
	 */
