...
public interface RepoAddition {
     ...
     * The <code>collectionDataType</code> can be created using the component.factory, i.e.
     ...
     * class.<br>
     * The <code>compositeDataType</code> can be created using the component.factory, i.e.
