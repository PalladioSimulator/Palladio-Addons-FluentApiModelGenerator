...
public abstract class ComplexComponent extends Component {
     ...
     * component.factory, i.e. <code>create.fetchOfComponent(name)</code>.
     * </p>
     *
     ...
     * @see component.factory.FluentRepositoryFactory#fetchOfComponent(String)
     */
     ...
     * @see component.factory.FluentRepositoryFactory#fetchOfOperationProvidedRole(String)
     ...
     * repository using the component.factory.
     * </p>
     *
     * @param assemblyContext
     * @param eventChannel
     ...
     * @return the component in the making
     * @see component.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
     * @see component.factory.FluentRepositoryFactory#fetchOfInfrastructureProvidedRole(String)
     * @see component.factory.FluentRepositoryFactory#fetchOfInfrastructureRequiredRole(String)
     */
     ...
     * @return the component in the making
     * @see component.factory.FluentRepositoryFactory#fetchOfAssemblyContext(String)
     * @see component.factory.FluentRepositoryFactory#fetchOfResourceRequiredRole(String)
     */
