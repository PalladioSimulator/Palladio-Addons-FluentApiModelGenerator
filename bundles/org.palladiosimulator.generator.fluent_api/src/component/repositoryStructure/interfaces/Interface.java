...
public abstract class Interface extends RepositoryEntity {
     ...
     * using the component.factory, i.e. <code>create.fetchOfInterface(name)</code>.
     * </p>
     *
     * @param parentInterface
     * @return this interface/event group in the making
     * @see component.factory.FluentRepositoryFactory#fetchOfInterface(String)
     ...
     * type can be fetched from the repository using the component.factory, i.e.
     ...
     * @return this interface/event group in the making
     * @see component.factory.FluentRepositoryFactory#fetchOfParameter(String)
     * @see component.factory.FluentRepositoryFactory#fetchOfParameter(String,
