...
public interface IAllocationAddition {
	...
	/**
	 * Defines the {@link org.palladiosimulator.pcm.resourceenvironment.ResourceEnvironment ResourceEnvironmet} used for the allocation.
	 * 
	 * @param environment
	...
	/**
	 * Adds an {@link org.palladiosimulator.pcm.allocation.AllocationContext AllocationContext} to the allocation.
	 ...
	 * @see allocationModel.factory.FluentAllocationFactory#newAllocationContext()
	 */
