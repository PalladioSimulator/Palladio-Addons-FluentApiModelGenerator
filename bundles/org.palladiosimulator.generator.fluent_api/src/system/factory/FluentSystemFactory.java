...
import system.structure.connector.event.AssemblyEventConnectorCreator;
import system.structure.connector.event.EventChannelSinkConnectorCreator;
import system.structure.connector.event.EventChannelSourceConnectorCreator;
import system.structure.connector.event.SinkDelegationConnectorCreator;
import system.structure.connector.event.SourceDelegationConnectorCreator;
import system.structure.connector.infrastructure.AssemblyInfrastructureConnectorCreator;
import system.structure.connector.infrastructure.ProvidedInfrastructureDelegationConnectorCreator;
import system.structure.connector.infrastructure.RequiredInfrastructureDelegationConnectorCreator;
import system.structure.connector.operation.AssemblyConnectorCreator;
import system.structure.connector.operation.ProvidedDelegationConnectorCreator;
import system.structure.connector.operation.RequiredDelegationConnectorCreator;
import system.structure.connector.resource.RequiredResourceDelegationConnectorCreator;
