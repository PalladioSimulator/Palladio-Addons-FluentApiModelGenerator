...
public abstract class Interface extends RepositoryEntity {
     ...
     * @see org.palladiosimulator.generator.fluent.component.factory.FluentRepositoryFactory#fetchOfInterface(String)
     ...
     * type can be fetched from the repository using the
     ...
     * @return this interface/event group in the making
     * @see org.palladiosimulator.generator.fluent.component.factory.FluentRepositoryFactory#fetchOfParameter(String)
     * @see org.palladiosimulator.generator.fluent.component.factory.FluentRepositoryFactory#fetchOfParameter(String,
