...
public class ProvidedDelegationConnectorCreator extends AbstractConnectorCreator {
     ...
     * OperationProvidedRole} of the org.palladiosimulator.generator.fluent_api.system, delegated to an AssemblyContext.
     *
     * @param role
    ...
    /**
     * Defines the {@link org.palladiosimulator.pcm.repository.OperationProvidedRole
     * OperationProvidedRole} of the org.palladiosimulator.generator.fluent_api.system, delegated to an AssemblyContext. The
     * provided roles added to the org.palladiosimulator.generator.fluent_api.system are searched for one that matches the
     * given name.
     *
     * @param role
     * @return this connector
