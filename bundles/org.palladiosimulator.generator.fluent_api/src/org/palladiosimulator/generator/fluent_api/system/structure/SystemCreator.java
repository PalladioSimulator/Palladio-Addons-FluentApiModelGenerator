...
import org.palladiosimulator.generator.fluent_api.system.apiControlFlowInterfaces.ISystemAddition;
...
public class SystemCreator extends SystemEntity implements ISystem {
    ...
    /**
     * Searches the repositories added to the org.palladiosimulator.generator.fluent_api.system for an
     ...
     * AssemblyContext}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given name.
     *
     * @param name
     ...
     * ResourceRequiredRole}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given
     * name.
     *
     * @param name
     ...
     * OperationRequiredRole}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given
     * name.
     *
     * @param name
     * @return the matching role
     ...
     * OperationProvidedRole}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given
     * name.
     *
     * @param name
     * @return the matching role
     ...
     * added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given name.
     *
     * @param name
     * @return the matching role
     * @throws NoSuchElementException Thrown if no element matches the given name
     ...
     * InfrastructureRequiredRole}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the
     * given name.
     *
     * @param name
     * @return the matching role
     ...
     * InfrastructureProvidedRole}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the
     * given name.
     *
     * @param name
     * @return the matching role
     ...
     * SourceRole}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given name.
     *
     * @param name
     * @return the matching role
     * @throws NoSuchElementException Thrown if no element matches the given name
     ...
     * EventChannel}s added to the org.palladiosimulator.generator.fluent_api.system for one that matches the given name.
     *
     * @param name
     ...
     */
    public ResourceInterface getResourceInterface(final org.palladiosimulator.generator.fluent_api.shared.structure.ResourceInterface resource) {
