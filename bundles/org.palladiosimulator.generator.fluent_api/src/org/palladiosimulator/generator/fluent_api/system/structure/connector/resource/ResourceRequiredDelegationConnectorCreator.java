package org.palladiosimulator.generator.fluent_api.system.structure.connector.resource;
...
public class ResourceRequiredDelegationConnectorCreator {
     ...
     * ResourceRequiredRole} of the org.palladiosimulator.generator.fluent_api.system, delegated to an AssemblyContext.
     *
     * @param role
    ...
    /**
     * Defines the {@link org.palladiosimulator.pcm.core.entity.ResourceRequiredRole
     * ResourceRequiredRole} of the org.palladiosimulator.generator.fluent_api.system, delegated to an AssemblyContext. The
     * required roles added to the org.palladiosimulator.generator.fluent_api.system are searched for one that matches the
     * given name.
     *
     * @param role
     * @return this connector
     ...
     * added to the org.palladiosimulator.generator.fluent_api.system are searched for a resource required role that matches
     * the given name.
     *
     * @param role
     * @return this connector
