package org.palladiosimulator.generator.fluent_api.shared.util;
...
public class ModelLoader {
     ...
     *
     * @param uri
     * @return the org.palladiosimulator.generator.fluent_api.system
     * @see org.palladiosimulator.pcm.system.System
     */
    public static System loadSystem(final String uri) {
        return (System) load(uri, "org.palladiosimulator.generator.fluent_api.system");
    }
    ...
    public static ResourceEnvironment loadResourceEnvironment(final String uri) {
        return (ResourceEnvironment) load(uri, "org.palladiosimulator.generator.fluent_api.resourceenvironment");
    }
     ...
     *
     * @param uri
     * @return the org.palladiosimulator.generator.fluent_api.allocation
     * @see org.palladiosimulator.pcm.allocation.Allocation
     */
    public static Allocation loadAllocation(final String uri) {
        return (Allocation) load(uri, "org.palladiosimulator.generator.fluent_api.allocation");
    }

    private static EObject load(final String uri, final String type) {
        ResourcetypePackage.eINSTANCE.eClass();
        // Register the XMI resource org.palladiosimulator.generator.fluent_api.component.factory for the .resourcetype extension
