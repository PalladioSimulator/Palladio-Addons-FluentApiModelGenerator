...
public class EventGroupCreator extends Interface {
     ...
     * The <code>eventType</code> can be created using the org.palladiosimulator.generator.fluent_api.component.factory, i.e.
     * <code>create.newEventType()</code>.
     *
     * @param eventType
     * @return this event group in the making
     * @see org.palladiosimulator.generator.fluent_api.component.factory.FluentRepositoryFactory#newEventType()
     */
