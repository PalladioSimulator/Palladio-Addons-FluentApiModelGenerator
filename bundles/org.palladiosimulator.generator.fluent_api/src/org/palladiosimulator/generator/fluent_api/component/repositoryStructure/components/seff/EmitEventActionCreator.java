...
public class EmitEventActionCreator extends SeffAction {
     ...
     * the org.palladiosimulator.generator.fluent_api.component.factory, i.e. <code>create.fetchOfEventType(name)</code>.
     * </p>
     *
     * @param eventType
     * @return this emit event action in the making
     * @see org.palladiosimulator.generator.fluent_api.component.factory.FluentRepositoryFactory#fetchOfEventType(String)
     */
     ...
     * the org.palladiosimulator.generator.fluent_api.component.factory, i.e. <code>create.fetchOfSourceRole(name)</code>.
     * </p>
     *
     * @param sourceRole
     * @return this emit event action in the making
